...
var describeCompassRun = !utils.hasProgram('compass')
  ? describe.skip
  : describe
...
describe('express(1)', function () {
  ...
  describe('--css <engine>', function () {
    ...
    describe('compass', function () {
      ...
      it('should create basic app with compass files', function (done) {
      ...
      it('should have node-compass in package dependencies', function () {
        ...
        assert.strictEqual(typeof pkg.dependencies['node-compass'], 'string')
      })
      ...
      describeCompassRun('npm start', function () {
        before('start app', function () {
          this.app = new AppRunner(ctx.dir)
        })
