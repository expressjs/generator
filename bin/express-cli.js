...
=======
  ...
  if (launchedFromCmd()) {
    console.log('     %s SET DEBUG=%s:* & npm start or yarn start', prompt, name)
  } else {
    console.log('     %s DEBUG=%s:* npm start or yarn start', prompt, name)
  }
>>>>>>> dab0a3d35d7254b87a87791275cec7889fe95e3d
